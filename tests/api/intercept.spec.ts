...
//intercept the network calls...and print on the console
//use case, maybe analysing something from the logs
test('intercept and log requests', async ({ page }) => {

    //like a call back arrow function
