...
/**
 * 
 * @returns this method is returning the actual product data: header, images,metadat, pricing data
 */
    //public method, call 2 private methods below
...
private  async getProductPricing() : Promise<void> {
     ...
     this.map.set('ExTacPrince', productPrice);
